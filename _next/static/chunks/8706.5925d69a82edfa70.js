"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[8706],{48706:function(e,n,t){t.r(n),t.d(n,{ConnectionStatusScreen:function(){return k},ConnectionStatusView:function(){return C},default:function(){return k},getErrorDetails:function(){return S}});var o=t(57437),r=t(2265),a=t(97048),i=t(1801),l=t(51156),c=t(19146),s=t(54990),d=t(25310),u=t(98802),p=t(3781),g=t(93610),h=t(31669),v=t(71554),f=t(87759),y=t(53535),m=t(1342),x=t(60716),b=t(84667);t(1470),t(64131),t(78984),t(29155);let w=e=>{let n=localStorage.getItem("-walletlink:https://www.walletlink.org:Addresses")?.split(" ").filter(e=>g.v(e,{strict:!0})).map(e=>h.K(e));return!!n?.length&&!!e?.linkedAccounts.filter(e=>"wallet"==e.type&&n.includes(e.address)).length},S=e=>e?.privyErrorCode===v.b.LINKED_TO_ANOTHER_USER?u.C.ERROR_USER_EXISTS:e instanceof u.P&&!e.details.default?e.details:e instanceof u.d?u.C.ERROR_TIMED_OUT:e?.privyErrorCode===v.b.CANNOT_LINK_MORE_OF_TYPE?u.C.ERROR_USER_LIMIT_REACHED:u.C.ERROR_WALLET_CONNECTION,C=({walletLogo:e,title:n,subtitle:t,signSuccess:r,errorMessage:a,connectSuccess:i,separateConnectAndSign:l,signing:s,walletConnectRedirectUri:p,walletConnectFallbackUniversalUri:g,hasTabbedAway:h,showCoinbaseWalletResetCta:v,numRetries:f,onBack:y,onSign:m,onRetry:x,onCoinbaseReset:w,onDifferentWallet:S})=>{let{t:C}=(0,d.u)(),k=v?{label:"Use a different wallet",onClick:w,disabled:r}:a===u.C.ERROR_USER_EXISTS&&y?{label:"Use a different wallet",onClick:S}:i&&!r&&l?{label:s?"Signing":"Sign with your wallet",onClick:m,disabled:s}:!r&&a?.retryable&&f<2?{label:"Retry",onClick:x,disabled:!1}:r||a?void 0:{label:C("connectionStatus.connecting"),onClick:()=>{},disabled:!0};return(0,o.jsx)(b.S,{title:n,subtitle:t,icon:e,iconVariant:"loading",iconLoadingStatus:{success:r,fail:!!a},primaryCta:k,onBack:y,watermark:!0,children:!i&&p&&!h&&(0,o.jsxs)(E,{children:[C("connectionStatus.stillHere")," ",(0,o.jsx)(c.L,{href:p,target:"_blank",variant:"underlined",size:"sm",children:C("connectionStatus.tryConnectingAgain")}),g&&(0,o.jsxs)(o.Fragment,{children:[" ",C("connectionStatus.or")," ",(0,o.jsx)(c.L,{href:g,target:"_blank",variant:"underlined",size:"sm",children:C("connectionStatus.useDifferentLink")})]})]})})},k={component:()=>{var e,n;let t,i,[c,g]=(0,r.useState)(!1),[h,b]=(0,r.useState)(!1),[k,E]=(0,r.useState)(void 0),{authenticated:T,logout:j}=(0,f.u)(),{navigate:_,navigateBack:W,lastScreen:R,currentScreen:z,setModalData:A,data:L}=(0,f.a)(),N=(0,s.u)(),{t:$}=(0,d.u)(),{getAuthFlow:I,walletConnectionStatus:O,closePrivyModal:U,initLoginWithWallet:F,loginWithWallet:M,updateWallets:D,createAnalyticsEvent:B}=(0,v.u)(),{walletConnectors:q}=(0,f.u)(),[H,V]=(0,r.useState)(0),{user:P}=(0,f.u)(),Y=(0,m.u)(),[X]=(0,r.useState)(P?.linkedAccounts.length||0),[K,G]=(0,r.useState)(""),[Q,J]=(0,r.useState)(""),[Z,ee]=(0,r.useState)(!1),{hasTabbedAway:en}=function(){let[e,n]=(0,r.useState)(!1),t=(0,r.useCallback)(()=>{document.hidden&&n(!0)},[]);return(0,r.useEffect)(()=>(document.addEventListener("visibilitychange",t),()=>document.removeEventListener("visibilitychange",t)),[t]),{hasTabbedAway:e,reset:()=>n(!1)}}(),{enabled:et,token:eo}=(0,l.a)(),er=(0,p.Q)(O?.connector?.walletClientType||"unknown"),ea=a.tq&&"wallet_connect_v2"===O?.connector?.connectorType||a.tq&&"coinbase_wallet"===O?.connector?.connectorType||a.tq&&"base_account"===O?.connector?.connectorType||a.tq&&"injected"===O?.connector?.connectorType&&"phantom"===O?.connector?.walletClientType||a.tq&&"solana_adapter"===O?.connector?.connectorType&&"mobile_wallet_adapter"===O.connector.walletClientType,ei="connected"===O?.status,el="switching_to_supported_chain"===O?.status;(0,r.useEffect)(()=>{let e=I(),n=e instanceof l.b||e instanceof l.S?e:void 0;ei&&"solana"===O.connector?.chainType&&"phantom"===O.connector?.walletClientType&&Y(x.e)&&void 0===L?.login?.isSigningInWithLedgerSolana?_("ConnectLedgerScreen",!1):(ei&&!n&&(!et||eo||T?F(O.connectedWallet,eo,L?.login?.disableSignup,L?.login?.isSigningInWithLedgerSolana?"transaction":"plain").then(()=>{ee(!0)}):(A({captchaModalData:{callback:e=>F(O.connectedWallet,e,L?.login?.disableSignup,L?.login?.isSigningInWithLedgerSolana?"transaction":"plain").then(()=>{ee(!0)}),userIntentRequired:!1,onSuccessNavigateTo:"ConnectionStatusScreen",onErrorNavigateTo:"ErrorScreen"}}),_("CaptchaScreen",!1))),n instanceof l.S&&L?.login?.isSigningInWithLedgerSolana&&(n.messageType="transaction"),n&&ea&&ei&&!n.preparedMessage?n.buildMessage():n&&!ea&&ei&&(h||(async()=>{b(!0),E(void 0);try{"wallet_connect_v2"===O?.connector?.connectorType&&"metamask"===O?.connector?.walletClientType&&await (0,p.k)(2500),await es()}catch(e){console.warn("Auto-prompted signature failed",e)}finally{b(!1)}})()))},[H,ei,Z]),(0,r.useEffect)(()=>{if(P&&c){let e=s.q-500;if(N?.legal.requireUsersAcceptTerms&&!P.hasAcceptedTerms){let n=setTimeout(()=>{_("AffirmativeConsentScreen")},e);return()=>clearTimeout(n)}if((0,y.s)(P,N.embeddedWallets)){let n=setTimeout(()=>{A({createWallet:{onSuccess:()=>{},onFailure:e=>{console.error(e),B({eventName:"embedded_wallet_creation_failure_logout",payload:{error:e,screen:"ConnectionStatusScreen"}}),j()},callAuthOnSuccessOnClose:!0}}),_("EmbeddedWalletOnAccountCreateScreen")},e);return()=>clearTimeout(n)}D();let n=setTimeout(()=>U({shouldCallAuthOnSuccess:!0,isSuccess:!0}),s.q);return()=>clearTimeout(n)}},[P,c]);let ec=e=>{if(e?.privyErrorCode!==v.b.ALLOWLIST_REJECTED){if(e?.privyErrorCode===v.b.USER_LIMIT_REACHED)return console.error(new v.k(e).toString()),void _("UserLimitReachedScreen");if(e?.privyErrorCode!==v.b.USER_DOES_NOT_EXIST)return e?.privyErrorCode===v.b.ACCOUNT_TRANSFER_REQUIRED&&e.data?.data?.nonce?(A({accountTransfer:{nonce:e.data?.data?.nonce,account:I()?.meta.address,displayName:e.data?.data?.account?.displayName,externalWalletMetadata:{walletClientType:I()?.meta.walletClientType,chainId:I()?.meta.chainId,connectorType:I()?.meta.connectorType},linkMethod:I() instanceof l.b?"siwe":"siws",embeddedWalletAddress:e.data?.data?.otherUser?.embeddedWalletAddress}}),void _("LinkConflictScreen")):void E(S(e));_("AccountNotFoundScreen")}else _("AllowlistRejectionScreen")};async function es(){try{await M(),g(!0)}catch(e){ec(e)}finally{b(!1)}}(0,r.useEffect)(()=>{O?.connectError&&ec(O?.connectError)},[O]),e=()=>{let e="wallet_connect_v2"===ed&&O?.connector instanceof l.W?O.connector.redirectUri:void 0;e&&G(e);let n="wallet_connect_v2"===ed&&O?.connector instanceof l.W?O.connector.fallbackUniversalRedirectUri:void 0;n&&J(n)},n=O?.connector instanceof l.W&&!K?500:null,t=(0,r.useRef)(()=>{}),(0,r.useEffect)(()=>{t.current=e}),(0,r.useEffect)(()=>{if(null!==n){let e=setInterval(()=>t.current(),n||0);return()=>clearInterval(e)}},[n]);let ed=O?.connector?.connectorType||"injected",eu=O?.connector?.walletClientType||"unknown",ep=er?.metadata?.shortName||er?.name||O?.connector?.walletBranding.name||"Browser Extension",eg=er?.image_url?.md||O?.connector?.walletBranding.icon||(e=>(0,o.jsx)(l.B,{...e})),eh="Browser Extension"===ep?ep.toLowerCase():ep;i=c?$("connectionStatus.successfullyConnected",{walletName:eh}):k?$("connectionStatus.errorTitle",{errorMessage:k.message}):el?"Switching networks":ei?h&&ea?"Signing":"Sign to verify":`Waiting for ${eh}`;let ev=$("connectionStatus.checkOtherWindows");c?ev=X===(P?.linkedAccounts.length||0)?"Wallet was already linked.":"You're good to go!":H>=2&&k?ev="Unable to connect wallet":k?ev=k.detail:el?ev="Switch your wallet to the requested network.":ei&&ea?ev="Sign the message in your wallet to verify it belongs to you.":"metamask"===eu&&a.tq?ev="Click continue to open and connect MetaMask.":"metamask"===eu?ev="For the best experience, connect only one wallet at a time.":"wallet_connect"===ed?ev="Open your mobile wallet app to continue":"coinbase_wallet"===ed?(0,p.T)()||(ev=w(P)?"Continue with the Coinbase app. Not the right wallet? Reset your connection below.":"Confirm in the Coinbase app/popup to continue."):L?.login?.isSigningInWithLedgerSolana&&(ev="Ledger requires a transaction to verify your identity. You'll sign a transaction that performs no onchain action.");let ef=q?.walletConnectors?.find(e=>"coinbase_wallet"===e.walletClientType),ey="coinbase_wallet"===eu&&(w(P)||k===u.C.ERROR_USER_EXISTS);return(0,o.jsx)(C,{walletLogo:eg,title:i,subtitle:ev,signSuccess:c,errorMessage:k,connectSuccess:ei,separateConnectAndSign:ea,signing:h,walletConnectRedirectUri:K,walletConnectFallbackUniversalUri:Q,hasTabbedAway:en,showCoinbaseWalletResetCta:ey,numRetries:H,onBack:R&&z!==R?W:void 0,onSign:()=>{b(!0),es()},onRetry:()=>{V(H+1),E(void 0),ei?(b(!0),es()):O?.connectRetry()},onCoinbaseReset:()=>{ef&&ef?.disconnect()},onDifferentWallet:W})}},E=i.zo.p`
  text-align: center;
...
`,i=({size:e="md",variant:n="navigation",disabled:t=!1,as:r,children:i,onClick:l,...c})=>(0,o.jsx)(a,{as:r,$size:e,$variant:n,$disabled:t,onClick:e=>{t?e.preventDefault():l?.(e)},...c,children:i})},40693:function(e,n,t){t.d(n,{S:function(){return S}});var o=t(57437),r=t(2265),a=t(1801),i=t(3781),l=t(51830),c=t(20278);let s=a.zo.div`
  /* spacing tokens */
