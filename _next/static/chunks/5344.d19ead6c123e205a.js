"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[5344],{79205:function(e,r,t){t.d(r,{Z:function(){return p}});var i=t(2265);let n=e=>e.replace(/([a-z0-9])([A-Z])/g,"$1-$2").toLowerCase(),o=e=>e.replace(/^([A-Z])|[\s-_]+(\w)/g,(e,r,t)=>t?t.toUpperCase():r.toLowerCase()),a=e=>{let r=o(e);return r.charAt(0).toUpperCase()+r.slice(1)},l=function(){for(var e=arguments.length,r=Array(e),t=0;t<e;t++)r[t]=arguments[t];return r.filter((e,r,t)=>!!e&&""!==e.trim()&&t.indexOf(e)===r).join(" ").trim()},s=e=>{for(let r in e)if(r.startsWith("aria-")||"role"===r||"title"===r)return!0};var c={xmlns:"http://www.w3.org/2000/svg",width:24,height:24,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:2,strokeLinecap:"round",strokeLinejoin:"round"};let d=(0,i.forwardRef)((e,r)=>{let{color:t="currentColor",size:n=24,strokeWidth:o=2,absoluteStrokeWidth:a,className:d="",children:p,iconNode:u,...h}=e;return(0,i.createElement)("svg",{ref:r,...c,width:n,height:n,stroke:t,strokeWidth:a?24*Number(o)/Number(n):o,className:l("lucide",d),...!p&&!s(h)&&{"aria-hidden":"true"},...h},[...u.map(e=>{let[r,t]=e;return(0,i.createElement)(r,t)}),...Array.isArray(p)?p:[p]])}),p=(e,r)=>{let t=(0,i.forwardRef)((t,o)=>{let{className:s,...c}=t;return(0,i.createElement)(d,{ref:o,iconNode:r,className:l("lucide-".concat(n(a(e))),"lucide-".concat(e),s),...c})});return t.displayName=a(e),t}},99388:function(e,r,t){t.d(r,{Z:function(){return i}});let i=(0,t(79205).Z)("circle-x",[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["path",{d:"m15 9-6 6",key:"1uzhvr"}],["path",{d:"m9 9 6 6",key:"z0biqf"}]])},25344:function(e,r,t){t.r(r),t.d(r,{EmbeddedWalletConnectingScreen:function(){return p},EmbeddedWalletConnectingView:function(){return d},default:function(){return p}});var i=t(57437),n=t(99388),o=t(2265),a=t(51156),l=t(71554),s=t(87759),c=t(84667);t(1470),t(29155),t(97048),t(64131),t(78984);let d=({connectionFailed:e,onClose:r})=>(0,i.jsx)(c.S,e?{title:"Something went wrong",subtitle:"We're on it. Please try again later.",icon:n.Z,iconVariant:"error",primaryCta:{label:"Close",onClick:r},watermark:!0}:{title:"Connecting to your wallet",subtitle:"Please wait...",iconVariant:"loading",showClose:!0,onClose:r,watermark:!1}),p={component:()=>{let{authenticated:e,user:r}=(0,s.u)(),{client:t,closePrivyModal:n,createAnalyticsEvent:c,walletProxy:p}=(0,l.u)(),{navigate:u,data:h,setModalData:v,onUserCloseViaDialogOrKeybindRef:g}=(0,s.a)(),f=(0,o.useMemo)(()=>Date.now(),[]),[x,y]=(0,o.useState)(!1),{onCompleteNavigateTo:m,onFailure:b,shouldForceMFA:w,entropyId:j,entropyIdVerifier:k,recoveryMethod:z,connectingWalletAddress:C,isUnifiedWallet:E=!1}=h?.connectWallet,S=e=>{x||(y(!0),b("string"==typeof e?Error(e):e))};return(0,o.useEffect)(()=>{let r;return e?p?((async()=>{let e=await t.getAccessToken();if(!e)return S("User must be authenticated and have a Privy wallet before it can be connected");try{if(!E){if(!j||!k)return S("For on-device first-class chain wallets, entropyId and entropyIdVerifier are required");await p.connect({accessToken:e,entropyId:j,entropyIdVerifier:k})}w&&await p.verifyMfa({accessToken:e});let t=(Date.now()-f)/1e3;"EmbeddedWalletKeyExportScreen"===m&&t<1?r=setTimeout(()=>{u(m,!1)},1e3*(1-t)):u(m,!1)}catch(e){if((0,a.e)(e)&&"privy"===z){let e=await t.getAccessToken();if(!e)return S("User must be authenticated and have a Privy wallet before it can be recovered");try{c({eventName:"embedded_wallet_pinless_recovery_started",payload:{walletAddress:C}});let r=await p?.recover({accessToken:e,entropyId:j,entropyIdVerifier:k});r?.entropyId||S(Error("Unable to recover wallet")),m?u(m):n({shouldCallAuthOnSuccess:!1}),c({eventName:"embedded_wallet_recovery_completed",payload:{walletAddress:C}}),u(m)}catch(e){S("An error has occurred, please try again.")}}else(0,a.e)(e)&&"privy"!==z&&"privy-v2"!==z?(v({...h,recoverWallet:{entropyId:j,entropyIdVerifier:k,onCompleteNavigateTo:m,onFailure:b},recoveryOAuthStatus:{provider:z,action:"recover",isInAccountCreateFlow:!1,shouldCreateEth:!1,shouldCreateSol:!1}}),u((0,a.c)(z))):S(e)}})(),()=>clearTimeout(r)):void 0:S("User must be authenticated and have a Privy wallet before it can be connected")},[e,r,p]),g.current=()=>{S("User exited before wallet could be connected"),n({shouldCallAuthOnSuccess:!1})},(0,i.jsx)(d,{connectionFailed:x,onClose:()=>n({shouldCallAuthOnSuccess:!1})})}}},40693:function(e,r,t){t.d(r,{S:function(){return j}});var i=t(57437),n=t(2265),o=t(1801),a=t(3781),l=t(51830),s=t(20278);let c=o.zo.div`
  /* spacing tokens */
